...
public class Tess4JTest {
    ...
    private final String abTestDataPath = "D:\\tmp\\OCR\\tessdata";
    ...
    public void testDoOCR_File() throws Exception {
        ...
        File imageFile = new File(this.testResourcesDataPath, "identity.png");
        //set language
        instance.setDatapath(abTestDataPath);
    ...
    public void testDoOCR_BufferedImage() throws Exception {
        ...
        File imageFile = new File(this.testResourcesDataPath, "identify.png");
